...
int main() {
    ...
    printf("===============================================================\n");
    printf("|                                                             |\n");
    printf("|              ---- SELAMAT DATANG DI DWIVAGO----             |\n");
    printf("|                                                             |\n");
    printf("===============================================================\n");
    printf("|                        1. Hotel Mulia                       |\n");
    printf("|                        2. Hotel Four Season                 |\n");
    printf("|                        3. Hotel Pullman                     |\n");
    printf("|                        4. Hotel Sari Pacific                |\n");
    printf("|                        5. Hotel Aston                       |\n");
    printf("===============================================================\n");
...
//Pemilihan Hotel
    switch (hotel) {
        case 1:
            ...
            break;
        case 2:
            printf("Hotel Four Season\n");
            break;
        case 3:
            printf("Hotel Pullman\n");
            break;
        case 4:
            printf("Hotel Sari Pacific\n");
            break;
        case 5:
            printf("Hotel Aston\n");
            break;
